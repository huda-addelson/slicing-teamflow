...
export default function Hero() {
  return (
    <div className='container mx-auto flex w-full h-full items-center'>
      {/* Desc Hero */}
      <div className='flex flex-col gap-y-2 w-3/5 '>
        <span className='text-xl p-2 bg-secondary rounded-md pr-6 font-thin w-fit'>
          👋 Welcome to TeamFlow
        </span>
        <h2 className='text-[64px] font-extrabold max-w-2xl text-white leading-tight'>
